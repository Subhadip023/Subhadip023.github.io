  ...
  manuElement.addEventListener("click", function() {
    lists.forEach(function(list) {
      ...
      {
        manuElement.innerHTML=`     <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="100" height="100" viewBox="0 0 48 48" style="fill:#FFFFFF;">
  ...
  function autoScroll() {
    projectsDiv.scrollTop += 1;
    if (projectsDiv.scrollTop >= projectsDiv.scrollHeight - projectsDiv.clientHeight) {
      projectsDiv.scrollTop = 0; // Restart the scroll
    }
  }
